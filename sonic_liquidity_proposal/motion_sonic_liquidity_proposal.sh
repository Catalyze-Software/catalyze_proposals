...
Following this motion proposal, we will submit 2 additional proposals to apply for the transfer of 2390 ICP and 350.000 CAT tokens, respectively from the Catalyze DAO treasury to the ICP/CAT Swap canister. \n\n
